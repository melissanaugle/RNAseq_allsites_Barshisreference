...
setwd("~/Desktop/GitHub/RNAseq_allsites_Barshisreference/GO/GO_MWU/")

# Edit these to match your data file names: 
input="contigs_signif_file_GOMWU_all_heat_v_control_logfoldchange.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
...
#	absValue=1, # un-remark this if you are using log2-fold changes
	...
	level3=0.000000001, # FDR cutoff to print in large bold font.
