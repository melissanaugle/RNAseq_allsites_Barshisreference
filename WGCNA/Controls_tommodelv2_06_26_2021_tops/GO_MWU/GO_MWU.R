...
setwd("~/Desktop/GitHub/RNAseq_allsites_Barshisreference/WGCNA/Controls_tommodelv2_06_26_2021_tops/GO_MWU/")
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
	...
	smallest=4,   # a GO category should contain at least this many genes to be considered, 
...
results <- results[[1]]
write.csv(results, "GO_MWU_honeydew1_BP.csv")
