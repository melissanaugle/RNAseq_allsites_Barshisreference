...
setwd("~/Desktop/GitHub/RNAseq_allsites_Barshisreference/WGCNA/Heats_thermotol_vatialowpoll_06_18_2021/GO_MWU/")

# Edit these to match your data file names: 
input="contigs_signif_file_GOMWU_lightgreenmodule_WGNCA_heatsonly.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).
...
gomwuStats(input, goDatabase, goAnnotations, goDivision,
	...
	largest=0.3,  # a GO category will not be considered if it contains more than this fraction of the total number of genes
	#originally largest = 0.1
	smallest=1,   # a GO category should contain at least this many genes to be considered, 
...
#	absValue=1, # un-remark this if you are using log2-fold changes
	...
	colors=c("black","firebrick1","black","lightcoral") # these are default colors, un-remar and change if needed
)
