...
```{r}
datTraits = read.csv("controls_defense/phenotypedata_controls_pollutiononly.csv")
head(datTraits)
nrow(datTraits)
...
pdf(file="Trait_heatmap_controls_phenotype_07022021_pollonly.pdf", height=9, width=8)
labeledHeatmap(Matrix = moduleTraitCor,
xLabels = names(datTraits),
ySymbols = modLabels,
yLabels = modLabels,
...
cex.lab.x = 0.8,
zlim = c(-.8,.8),
main = paste("Module-Trait Correlations of Control \n and Heat Stress Treatments"))
dev.off()
```
