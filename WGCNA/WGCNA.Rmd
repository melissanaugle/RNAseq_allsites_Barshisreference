...
```{r}
datTraits = read.csv("Heats_tommodelv3_06_29_2021_thesis/phenotypedata_heats_tommodelv2_062921_thesis.csv")
head(datTraits)
nrow(datTraits)
...
pdf(file="Trait_heatmap_heats_phenotype_06292021.pdf", height=9, width=8)
labeledHeatmap(Matrix = moduleTraitCor,
xLabels = names(datTraits),
ySymbols = modLabels,
yLabels = modLabels,
...
cex.lab.x = 0.8,
zlim = c(-.8,.8),
main = paste("Module-Trait Correlations of Heat Stress Treatments"))
dev.off()
```
