...
phenotype_controls <- read.csv("Heats_tom_models_06_23_2021/phenotypedata_heats_thermotol_06232021.csv")

bleaching_data <- read.csv("Phenotype_data/UniqueColony_SCLERAModeling_2019.csv")
```
...
new_phenotype_controls <- new_phenotype_controls[,c(1,2,3,4,5,6,14,15,25,26,27)]

new_phenotype_controls <- merge(new_phenotype_controls, phenotype_controls, all = T)

new_phenotype_controls <- new_phenotype_controls[,c(1:11)]
...
new_phenotype_controls_res <- res[,c(1:11)]


write.csv(new_phenotype_controls_res, "Heats_tom_models_06_23_2021/phenotypedata_heats_thermotol_tommodel_06232021.csv", row.names = F)
