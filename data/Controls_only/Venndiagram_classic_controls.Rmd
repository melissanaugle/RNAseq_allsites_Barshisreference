...
##Barshis reference, just controls, for thesis

#1. Set WD, load packages

```{r setup}
setwd(dir = "~/Desktop/GitHub/RNAseq_allsites_Barshisreference/Controls_only/")
rm( list = ls())
graphics.off()
library(tidyverse) 
library(reshape2) 
...
CanE_CoPtE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Can_E_vs_CoPt_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
CanE_CoPtE <- setNames(cbind(rownames(CanE_CoPtE), CanE_CoPtE, row.names = NULL), c("ContigID", colnames(CanE_CoPtE)))
CanE_CoPtE <- select(CanE_CoPtE, "ContigID")

CanE_AluE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Can_E_vs_Falu_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
...
CanE_VatE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Can_E_vs_Vat_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
CanE_VatE <- setNames(cbind(rownames(CanE_VatE), CanE_VatE, row.names = NULL), c("ContigID", colnames(CanE_VatE)))
CanE_VatE <- select(CanE_VatE, "ContigID")

CanE_TeleE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Can_E_vs_Ftele_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
CanE_TeleE <- setNames(cbind(rownames(CanE_TeleE), CanE_TeleE, row.names = NULL), c("ContigID", colnames(CanE_TeleE)))
CanE_TeleE <- select(CanE_TeleE, "ContigID")

CoPtE_AluE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.CoPt_E_vs_Falu_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
...
CoPtE_TeleE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.CoPt_E_vs_Ftele_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
CoPtE_TeleE <- setNames(cbind(rownames(CoPtE_TeleE), CoPtE_TeleE, row.names = NULL), c("ContigID", colnames(CoPtE_TeleE)))
CoPtE_TeleE <- select(CoPtE_TeleE, "ContigID")

CoPtE_VatE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.CoPt_E_vs_Vat_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
CoPtE_VatE <- setNames(cbind(rownames(CoPtE_VatE), CoPtE_VatE, row.names = NULL), c("ContigID", colnames(CoPtE_VatE)))
CoPtE_VatE <- select(CoPtE_VatE, "ContigID")

AluE_TeleE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Falu_E_vs_Ftele_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
...
AluE_VatE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Falu_E_vs_Vat_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
...
TeleE_VatE <-read.csv("../../data/Controls_only/pairwise_comparisons/RSEM.isoform.counts.matrix.Ftele_E_vs_Vat_E.edgeR.DE_results.P0.05_C2.DE.subset", sep = "\t")
...
#now that I'm looking again- idk if this is right 5/14/21
...
#not the correct comparison - must fix this 
